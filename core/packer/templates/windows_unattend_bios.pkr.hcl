...
variable "windows_image_selector_type" { type = string }
variable "windows_image_selector_value" { type = string }
...
source "proxmox-iso" "windows" {
  ...
  qemu_agent           = true
  template_description = "Built by Capstone (Windows BIOS)"
}

build {
  name    = "capstone-windows-bios-template"
